...
void *__dso_handle = nullptr; // optimally, you should remove the '= 0' part and define this in your asm script
    ...
    **/
    if (__atexit_funcs[i].destructor_func == f) {
      ...
      **/
      ...
      // requires patching to deal with the FIXMEs outlined above.
    }
  }
}
